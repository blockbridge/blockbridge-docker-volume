...
The Blockbridge Volume Plugin integrates Docker with Blockbridge elastic block
storage using the v2 Docker Plugin API.
...
The Blockbridge Volume Plugin implements the full Docker Volume API. The Blockbridge
Volume Control Tools provide extended management capabilities as shown in the table
above.
